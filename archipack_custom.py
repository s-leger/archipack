...
from bpy.props import (
    FloatProperty, IntProperty, FloatVectorProperty, BoolProperty,
...
from .archipack_gl import FeedbackPanel, GlPolygon
...
class ARCHIPACK_OT_make_custom(Operator):
    ...
    def create(self, context):
        ...
        bound = Vector(act.bound_box[0]) + Vector(act.bound_box[6])
